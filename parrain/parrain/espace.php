...
if(isset($_SESSION["id"])){
   $id= $_SESSION["id"];
    ...
    $req=$db->query("SELECT * FROM parrain WHERE id='".$id."'");
    $result=$req->fetchAll();
...
<body>
    <div class="container">
<h1>MON ESPACE </h1>
<?php $req=$db->query("SELECT * FROM parrain, filleul WHERE parrain.id=filleul.idfilleul AND idparrain='".$cle."'")->fetchAll();
