...
<li><a href="https://www.wiki-php.fr/" title="Wiki PHP" target="">Wiki PHP</a></li>
    ...
    <div align="center">
        ...
        <?php include "modifier-profil.php" ?>
        <br>
        <h1>Modifier son mot de passe</h1>
        <?php include "modifier-mdp.php" ?>
...
<h1> Liste des partenaires</h1>
            ...
            <th>Email</th>
                ...
                <tbody>
                    <td>1</td>
                    <td>Nekessa</td>
                    <td>Nekessa@gmail.com</td>
                </tbody>
        </table>
        </div>
        <div class="card-body">
<h2>Lien de parainage</h2>
<p class="card-text"><b>http://localhost/Stage/2esemaine/register.php?p= </b></p>
